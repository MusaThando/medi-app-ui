if (localStorage.getItem("color"))
    $("#color").attr("href", "/Content/UI UX/css/" + localStorage.getItem("color") + ".css");
...
$(document).ready(function () {
     ...
     $(".customizer-color li").on('click', function() {
        ...
        localStorage.removeItem("dark");
         $("#color").attr("href", "/Content/UI UX/css/"+color+".css" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', '/Content/UI UX/images/logo/logo.png');
